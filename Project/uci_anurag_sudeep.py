...
# Fit the model
history=model.fit(X_train, Y_train,validation_split=0.1,callbacks=callbacks_list, nb_epoch=100, batch_size=10)
...
plt.savefig('accuracy_epochcount.png', bbox_inches='tight')
plt.show()

import pickle
pickle.dump( history, open( "accuracy_epochcount_history.pkl", "wb" ) )